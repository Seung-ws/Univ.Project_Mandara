...
/**
 * Servlet implementation class MandaraTargetOffer
 */
@WebServlet("/MandaraTargetIconOffer")
public class MandaraTargetIconOffer extends HttpServlet {
	...
	private void getMandaraImage(HttpServletRequest request, HttpServletResponse response)
	{
		...
		{
			String query="Select IconImage from MandaraImageOffer1 where No=? And MandaraName=?";
			try {
				...
				if(blob!=null)
				{
				    ...
				    response.setHeader("Content-Disposition", "attachment;filename="+m_name+".jpg");
