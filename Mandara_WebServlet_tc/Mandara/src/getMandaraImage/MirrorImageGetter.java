 ...
 */
@WebServlet("/MirrorImageGetter")
public class MirrorImageGetter extends HttpServlet {
	private static final long serialVersionUID = 1L;
	DataSource datafactory=null;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MirrorImageGetter() {
        super();
	...
	private void ImageGetter(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if(g_uid!=null&&toName!=null&&I_type!=null)
			{
				...
				String query = "Select mirrorImage from MandaraUserImage1 where g_uid=? AND toName=? AND I_type=?";				
