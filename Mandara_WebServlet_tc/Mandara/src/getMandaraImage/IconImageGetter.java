 ...
 */
@WebServlet("/IconImageGetter")
public class IconImageGetter extends HttpServlet {
	private static final long serialVersionUID = 1L;
	DataSource datafactory=null;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IconImageGetter() {
        super();
	...
	private void ImageGetter(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if(g_uid!=null&&toName!=null&&I_type!=null)
			{
				...
				String query = "Select iconImage from MandaraUserImage1 where g_uid=? AND toName=? AND I_type=?";				
				...
				if(blob!=null)
				{
				    ...
				    response.setHeader("Content-Disposition", "attachment;filename="+toName+".jpeg");
